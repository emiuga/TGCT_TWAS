---
title: "Miami plot for TGCT TWAS results (supplementary)"
...
file_out="Suppl.Figure_2.Miami_ggplot"
```
...
# legend
plot(1,1)
legend( "topleft" , legend=c("A", "B", "C"),  pch=c(19, 19, 19 ),  col=h_color, border = "black", cex=2, bty="n" )
```
...
# ALSO novel == 39 genes
pl_top_S2 <- pl_top + geom_point(data = subset(annot, PERM.nom=="yes" & GWAS_overlap=="No"), 
...
pl_top_S2 <- pl_top_S2 + geom_point(data = subset(annot, PERM.nom=="yes" & GWAS_overlap=="Yes"), 
...
pl_top_S2 <- pl_top_S2 + geom_label_repel(data = annot, 
                  aes(x = x, y = -log10(TWAS.P), label = Label), label.padding=0.1, label.r=0.2, size = 3.5, colour="black", 
